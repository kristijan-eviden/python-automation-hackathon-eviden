...
def run(playwright: Playwright) -> None:
    ...
    page.goto("https://www.google.com/search?q=microsoft+forms&oq=microsoft+forms&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDI4NDdqMGoyqAIAsAIA&sourceid=chrome&ie=UTF-8")
    page.get_by_role("button", name="Alle ablehnen").click()
    page.get_by_role("link", name="Microsoft Forms - Free tool").click()
    page.goto("https://www.google.com/search?q=search+something+else&oq=search+something+else&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDI2MDBqMGo0qAIAsAIA&sourceid=chrome&ie=UTF-8")
